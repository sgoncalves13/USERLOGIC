...
class Usuario(models.Model):
    documento = models.CharField(max_length=500, primary_key=True)
    clave = models.CharField(max_length=500, default='dafault')
    tipo = models.CharField(max_length=500, default='default')
    foto = models.CharField(max_length=500, default='default')
    nombre = models.CharField(max_length=500, default='default')
    edad = models.CharField(max_length=500, default='default')
    telefono = models.CharField(max_length=500, default='default')
    sexo = models.CharField(max_length=500, default='default')
